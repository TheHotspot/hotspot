...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        m2m_table_name = db.shorten_name(u'core_business_user')
        ...
        db.create_table(u'core_hotspot', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ...
        db.send_create_signal(u'core', ['Hotspot'])

        # Adding model 'CheckIn'
        db.create_table(u'core_checkin', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('hotspot', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Hotspot'])),
            ('time_in', self.gf('django.db.models.fields.DateTimeField')()),
            ('time_out', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal(u'core', ['CheckIn'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(db.shorten_name(u'core_business_user'))

        # Deleting model 'Hotspot'
        db.delete_table(u'core_hotspot')

        # Deleting model 'CheckIn'
        db.delete_table(u'core_checkin')
    ...
    models = {
        ...
        u'core.checkin': {
            ...
            'hotspot': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.Hotspot']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'core.hotspot': {
            ...
            'business': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.Business']"}),
