...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'User.telephone'
        db.delete_column(u'api_user', 'telephone')

        # Adding field 'User.gender'
        db.add_column(u'api_user', 'gender',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=1, blank=True),
                      keep_default=False)

        # Adding field 'User.status'
        db.add_column(u'api_user', 'status',
                      self.gf('django.db.models.fields.IntegerField')(default=0, blank=True),
                      keep_default=False)

        # Adding field 'User.birthdate'
        db.add_column(u'api_user', 'birthdate',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(1985, 11, 5, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'User.telephone'
        db.add_column(u'api_user', 'telephone',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=20, blank=True),
                      keep_default=False)

        # Deleting field 'User.gender'
        db.delete_column(u'api_user', 'gender')

        # Deleting field 'User.status'
        db.delete_column(u'api_user', 'status')

        # Deleting field 'User.birthdate'
        db.delete_column(u'api_user', 'birthdate')
